    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#"><i class="fa fa-users fa-fw"></i>Usuarios</a></li>
                <li><a href="#"><i class="fa fa-users fa-fw"></i>Eventos</a></li>
                <li><a href="#"><i class="fa fa-users fa-fw"></i>Charlas</a></li>
            </ul>
